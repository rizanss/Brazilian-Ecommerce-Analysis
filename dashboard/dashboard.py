...
# Load data
order_delivery_satisfaction_df = pd.read_csv('https://raw.githubusercontent.com/rizanss/Brazilian-Ecommerce-Analysis/main/data/order_delivery_satisfaction_df.csv')
avg_popularity_product_df = pd.read_csv('https://raw.githubusercontent.com/rizanss/Brazilian-Ecommerce-Analysis/main/data/avg_popularity_product.csv')
products_order_df = pd.read_csv('https://raw.githubusercontent.com/rizanss/Brazilian-Ecommerce-Analysis/main/data/products_order_df.csv')
daily_orders_df = pd.read_csv('https://raw.githubusercontent.com/rizanss/Brazilian-Ecommerce-Analysis/main/data/daily_orders.csv')
monthly_orders_df = pd.read_csv('https://raw.githubusercontent.com/rizanss/Brazilian-Ecommerce-Analysis/main/data/monthly_orders.csv')
